...
//  
//         Project Name:            UnSQLTest
//         Module  Name:          frmTest.cs
//         Part Of:                        UnSQL
...
namespace UnSQLTest
{
    public partial class frmTest : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            x.Install(Application.StartupPath + "\\db\\", Controller.InstallType.Super);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            x.Start(Application.StartupPath + "\\db\\");
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            x.Stop(Application.StartupPath + "\\db\\");
        }
        ...
        {
            var x = new Controller();
            x.UninstallComplete += x_UninstallComplete;
            x.Uninstall(Application.StartupPath + "\\db\\");
        }

        private void x_UninstallComplete()
        {
